          ...
          {skillCategories.map((category, index) => {
            ...
            return (
              <motion.div
                ...
                className="glass-card p-5 sm:p-6 rounded-xl sm:rounded-2xl backdrop-blur-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300"
              >
