        ...
        <div className="flex flex-col space-x-4 md:flex-row justify-center mx-8 md:mx-28 my-10  ">
          ...
          <Fade bottom>
            ...
            >
              ...
              <p className="skill-description">
                Developing through a series of iterations of development,
                testing and deployment. This helps my workflow through
                shortening development cycles and just in-time implementation of
                feature requests. Tools and processes I use include,
              </p>
              <p className="skill-list">
                Agile &nbsp;&nbsp;|&nbsp;&nbsp; Scrum &nbsp;&nbsp;|&nbsp;&nbsp;
                Kanban &nbsp;&nbsp;|&nbsp;&nbsp; git & github
