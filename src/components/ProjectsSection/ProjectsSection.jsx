...
function ProjectsSection() {
  ...
  let projects = [
    ...
    },
    {
      ...
      description: ` A social platform UI. The goal was to create a clean and simple UI that would be easy to use and intuitive. This was a collaboration project with a Nigerian based designer and implemented the design to code with a high conversion ratio.`,
      image: project5img,
